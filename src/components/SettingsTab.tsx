    ...
    <div className="w-full flex-1 overflow-y-auto px-5 pt-3 pb-24 select-none" id="pixel-settings-tab">
      ...
      <section className="mb-7">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-sm font-bold uppercase tracking-wider opacity-80">
            Controlli di Sistema & Auto
          </h2>
        </div>

        <div
          className="p-4 rounded-2xl space-y-2 border border-black/5"
          style={{ backgroundColor: palette.surfaceContainer }}
        >
          <div className="flex items-center justify-between">
            <h4 className="text-xs font-bold">Widget Schermata di Blocco (Lockscreen)</h4>
            <span
          ...
          <p className="text-[11px] opacity-75 leading-relaxed">
            Quando blocchi il telefono o spegni lo schermo, il lettore compare automaticamente nella schermata di blocco di Android (con barra a onda, titolo, copertina, tasti avanti/indietro) e nei comandi Bluetooth dell'auto, esattamente come YouTube e VLC.
          </p>
        </div>
      </section>
