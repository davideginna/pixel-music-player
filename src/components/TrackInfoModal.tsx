        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2 py-4 border-b border-black/10">
            <button
              ...
              className="flex flex-col items-center justify-center p-3 rounded-2xl hover:bg-black/5 transition text-center"
            >
            ...
            <button
              onClick={() => {
                if (confirm('Vuoi rimuovere questo brano dalla libreria locale?')) {
                  onDeleteTrack(track.id);
                  onClose();
                }
              }}
              className="flex flex-col items-center justify-center p-3 rounded-2xl hover:bg-red-500/10 text-red-500 transition text-center"
            >
